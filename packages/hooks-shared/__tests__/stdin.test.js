...
// readStdin consumes process.stdin, so we exercise it via a child process
// that prints the parsed result as JSON. Pure in-process testing would
// require monkey-patching process.stdin, which is brittle.
