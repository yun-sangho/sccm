 ...
 * Callers should still wrap in try/catch to handle malformed JSON —
 * a hook that throws blocks the whole chain, which is exactly the
 * failure mode we do not want.
 *
